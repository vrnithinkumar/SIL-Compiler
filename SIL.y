...
Start : Global_Declaration Function_Definitions  Main_Function {printf("Finally Cool Man \n");}
		|Main_Function {printf("Only main dude \n");}
		;


Global_Declaration : 
					DECL Variable_Declaration ENDDECL {printf("Glob");}
					;
